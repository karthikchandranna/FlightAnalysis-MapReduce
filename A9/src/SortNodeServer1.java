...
public class SortNodeServer1 implements Runnable
{
	...
	public SortNodeServer1(Socket conn) throws IOException
	{
	...
	{
		int port = 6073; // Have a common port later
		Socket socket = null;
		...
		try {
			...
			while (true) {
				...
				Runnable runnable = new SortNodeServer1(socket);
